...
| `FOAM_PREVIOUS_DAILY_NOTE` | The most recent daily note that exists before the one being created, skipping any gap. Daily note templates only. See [[daily-notes]].                                                                                                                                              |
