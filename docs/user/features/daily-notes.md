...
> NOTE: It is possible to set the filepath of a daily note according to the current date using [[Note Templates]] and special [[note-properties]]. See [Issue 842](https://github.com/foambubble/foam/issues/842) for details.
