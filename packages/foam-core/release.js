#!/usr/bin/env node
//
// Releases @foam/core to npm under the public name `foam-core`.
//
...
// 1. Clean + build (was: prepublishOnly).
run('yarn clean');
run('yarn build');

// 2. Rename to the public npm name. The workspace name `@foam/core` is a
//    monorepo-internal identifier; on npm we publish as `foam-core`.
//
