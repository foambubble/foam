...
For the time being we have decided to not build a mobile app, but rely on third parties.
...
- Doesn't generate link reference lists (but this is ok, since [[workspace-lint]] as a GitHub action can solve this)
