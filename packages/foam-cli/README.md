...
foam-cli/0.5.0-alpha.0 darwin-x64 node-v10.19.0
$ foam --help [COMMAND]
USAGE
  $ foam COMMAND
...
...
_See code: [src/commands/janitor.ts](https://github.com/foambubble/foam/blob/v0.5.0-alpha.0/src/commands/janitor.ts)_
...
_See code: [src/commands/migrate.ts](https://github.com/foambubble/foam/blob/v0.5.0-alpha.0/src/commands/migrate.ts)_
<!-- commandsstop -->
